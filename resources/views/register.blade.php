                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Création de Compte</h5>
                                    <p class="text-muted">Créer un compte gratuitement pour continuer</p>
                                </div>
                                <div class="p-2 mt-4">
                                    @if ($errors->any())
                                    ...
                                    <form  method="post" action="{{route('register')}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="prenom" class="form-control" required name="prenom">
                                        </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="font-size-14 mb-3 title">S'inscrire avec</h5>
                                            </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="text-muted mb-0">j'ai déja un compte ? <a href="#" class="fw-medium text-primary"> Se connecter</a></p>
                                        </div>
                                    </form>
                                </div>
